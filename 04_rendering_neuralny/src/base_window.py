...
from utils.config import GL_VERSION, IMAGE_COUNT, WINDOW_SIZE, WINDOW_TITLE
...
class BaseWindow(WindowConfig):
    ...
    def __init__(self, **kwargs):
        ...
        kwargs["renderer_type"] = getattr(self.argv, "renderer_type", None)
    ...
    def add_arguments(cls, parser):
        ...
        parser.add_argument(
            "--output_path", type=str, required=False, help="Where to save an image"
        )
        parser.add_argument(
            "--renderer_type", type=str, required=False, help="Type of renderer to use"
        )
        parser.add_argument(
            "--model_path", type=str, required=False, help="Path to the model"
        )
